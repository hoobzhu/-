...
angular.module('myApp.services').service('sysConfigService',['$http','sharedProperties','$q','$translate',function($http,sharedProperties,$q,$translate){
	  ...
	  var prefixUrl = sharedProperties.getServerUrl()+"/rest/v1/sys/config";
	  var configCache = {}; 
	 ...
	 self.listPicConfigs = function(){
		return $http.get(sharedProperties.getServerUrl()+'/rest/v1/sys/picconfig/list').then(function(r){
			return r.data.vo;
		});
