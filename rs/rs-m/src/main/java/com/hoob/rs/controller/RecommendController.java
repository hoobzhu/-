...
public class RecommendController {
	 ...
	 * 添加相似性内容推荐
	 * */
	@RequestMapping(method = RequestMethod.POST, path = "/v1/resimilarcontent/add",
	...
	@RequestMapping(method = RequestMethod.POST, path = "/v1/reusercontent/add",
			produces = {"application/json;charset=utf-8" })
	...
	@RequestMapping(method = RequestMethod.POST, path = "/v1/retopncontent/add",
			produces = {"application/json;charset=utf-8" })
	...
	@RequestMapping(method = RequestMethod.POST, path = "/v1/resimilarcontent/edit",
			produces = {"application/json;charset=utf-8" })
	...
	@RequestMapping(method = RequestMethod.POST, path = "/v1/reusercontent/edit",
			produces = {"application/json;charset=utf-8" })
	...
	@RequestMapping(method = RequestMethod.POST, path = "/v1/retopncontent/edit",
			produces = {"application/json;charset=utf-8" })
	...
	@RequestMapping(method = RequestMethod.POST, path = "/v1/retopncontent/delete",
			produces = {"application/json;charset=utf-8" })
	...
	@RequestMapping(method = RequestMethod.POST, path = "/v1/reusercontent/delete",
			produces = {"application/json;charset=utf-8" })
	...
	@RequestMapping(method = RequestMethod.POST, path = "/v1/resimilarcontent/delete",
			produces = {"application/json;charset=utf-8" })
	...
	@RequestMapping(method = RequestMethod.GET, path = "/v1/retopncontent/detail",
			produces = {"application/json;charset=utf-8" })
	...
	@RequestMapping(method = RequestMethod.GET, path = "/v1/reusercontent/detail",
			produces = {"application/json;charset=utf-8" })
	...
	@RequestMapping(method = RequestMethod.GET, path = "/v1/resimilarcontent/detail",
			produces = {"application/json;charset=utf-8" })
	...
	@RequestMapping(method = RequestMethod.GET, path = "/v1/resimilarcontent/check",
			produces = {"application/json;charset=utf-8" })
	...
	@RequestMapping(method = RequestMethod.GET, path = "/v1/reusercontent/check",
			produces = {"application/json;charset=utf-8" })
	...
	@RequestMapping(method = RequestMethod.GET, path = "/v1/retopncontent/check",
			produces = {"application/json;charset=utf-8" })
