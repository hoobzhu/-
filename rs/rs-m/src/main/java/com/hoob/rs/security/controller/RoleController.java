...
public class RoleController {
	...
	@RequestMapping(method=RequestMethod.POST,path="/v1/security/role/add",
	...
	@RequestMapping(method=RequestMethod.POST,path="/v1/security/role/edit",
			consumes={"application/json"},produces={"application/json"})
	...
	@RequestMapping(method=RequestMethod.POST,path="/v1/security/role/remove",
			consumes={"application/json"},produces={"application/json"})
