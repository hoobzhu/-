...
public class ScaleImageUtils {
	...
	/**
	 * <b>function:</b> 设置图片压缩质量枚举类； Some guidelines: 0.75 high quality、0.5
	 * medium quality、0.25 low quality
	 * 
	 * @author hoojo
	...
	public static String resize(int width, int height, Float quality,
			String savePath, Image targetImage) throws ImageFormatException,
			IOException {
		width = Math.max(width, 1);
		height = Math.max(height, 1);
		BufferedImage image = new BufferedImage(width, height,
