...
public interface BaseDao {
	...
	public <T> QueryResult<T> query(Class<T> clazz,int firstResult, int maxResult,
			String whereSql, Object[] params, HashMap<String, String> orderBy);

	public <T> QueryResult<T> query(Class<T> clazz,int firstResult, int maxResult, HashMap<String, String> orderBy);
	...
	public <T> QueryResult<T> query(CharSequence queryString,
			HashMap<String,Object>params,int firstResult, int maxResult);
	...
	public <T> List<T> execNativeQueryList(Class<T> clazz, CharSequence queryString,
			HashMap<String, Object> params, int firstResult, int maxResult);

	public <T> QueryResult<T> execNativeQuery(Class<T> clazz, CharSequence queryString,
			HashMap<String, Object> params, int firstResult, int maxResult);
