...
public final class StringUtils {
    ...
    /***/
	public static final String set2String(Set<Long> cpIds) {
	...
	public static String isRightfulDateRegex = "^(([0-9]{3}[1-9]|[0-9]{2}[1-9][0-9]{1}|[0-9]"
			+ "{1}[1-9][0-9]{2}|[1-9][0-9]{3})-(((0[13578]|1[02])-(0[1-9]|[12][0-9]|3[01]))"
    ...
    /***/
	public static String isRightfulTimeRegex = "^([0-1]{1}[0-9]{1}|2[0-3]{1}):[0-5]{1}[0-9]{1}$";
    /***/
	public static boolean isRightfulTime(String date) {
		return date.matches(isRightfulTimeRegex);
	}
