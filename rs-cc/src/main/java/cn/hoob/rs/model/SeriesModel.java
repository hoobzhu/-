...
public class SeriesModel implements Serializable{
	...
	public SeriesModel(Long id, String contentId, String kind,String programType, String cast,String catgoryids,long updateTime,Integer status) {
		super();
		this.id = id;
		this.contentId = contentId;
		this.kind = kind;
	...
	public SeriesModel(Long id, String contentId, String kind,String programType, String cast,String catgoryids,String similartyText,long updateTime,Integer status) {
		super();
		this.id = id;
		this.contentId = contentId;
		this.kind = kind;
	...
	public SeriesModel(Long id, String contentId, String kind,String programType, String cast,long updateTime,Integer status) {
		super();
		this.id = id;
		this.contentId = contentId;
		this.kind = kind;
