...
public class UserVO{
	...
	public UserVO(long id, String name, String role, String nickName, Date lastLoginTime, Integer loginTimes, Boolean enable,
				  String userId, String parentUserId, Integer userlevel, String userType, String cpId, String spId, Date createTime, Date updateTime) {
		this.id = id;
		this.name = name;
		this.role = role;
	...
	public UserVO(long id, String name, String role, String nickName, Date lastLoginTime, Integer loginTimes, Boolean enable,List<RoleVO> roles,
				  String userId, String parentUserId, Integer userlevel, String userType, String cpId, String spId, Date createTime, Date updateTime) {
		this.id = id;
		this.name = name;
		this.role = role;
