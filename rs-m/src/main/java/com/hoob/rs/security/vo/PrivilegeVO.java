...
//	private List<PrivilegeVO> childs;
	...
	public PrivilegeVO(long id, String menuCode, String menuTitle, int menuLevel, int menuType, String description, String url, int enable, Date createTime, Date updateTime,PrivilegeVO parent) {
		this.id = id;
	...
	public PrivilegeVO(long id, String menuCode, String menuTitle, int menuLevel, int menuType, String description, String url, int enable, long parentId) {
		this.id = id;
		this.menuCode = menuCode;
		this.menuTitle = menuTitle;
		this.menuLevel = menuLevel;
